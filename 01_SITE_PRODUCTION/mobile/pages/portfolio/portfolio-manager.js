class PortfolioManager {
    constructor() {
        ...
        this.projectFolders = [
            ...
            { 
                ...
                mainMedia: {
                    type: 'image',
                    src: '/Clara_Neulinger/05_PROJETS_3D/projets_portfolio/Kitchen/NewLevelSequence1_0002_Ultra.png?v=' + Date.now() // Force refresh cache
                }
            },
            { 
                folder: 'Room', 
                ...
                <div class="project-container">
                    ...
                    <div class="project-info-side">
                        ...
                        <div class="project-hint">
                            <small><span class="white-bulb">[INFO]</span> Double-cliquez sur ${project.mainMedia.type === 'video' ? 'la vidéo' : 'l\'image'} pour accéder au viewer 3D interactif</small>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="marmoset-main-container">
                    <div class="marmoset-gallery-panel">
                        ...
                        <div class="gallery-scroll-container" id="${project.folder.toLowerCase()}-gallery">
                            <zone-labels!-- Images seront ajoutées ici -->
                        </div>
                    </div>
                        ...
                        <div class="viewer-wrapper">
                            ${project.folder === 'Arch' ? 
                                ...
                                `<iframe id="marmoset-viewer-inline" 
                                        src="/Clara_Neulinger/05_PROJETS_3D/projets_portfolio/Gun/Plasma_Pistol_Viewer.html" 
                                        width="100%" 
                                        height="100%" 
                                        frameborder="0"
                                        allowfullscreen>
                                    <p>Chargement du viewer Plasma Pistol...</p>
                                </iframe>` :
                                `<iframe id="marmoset-viewer-inline" 
                    ...
                    <div class="marmoset-extra-panel">
                        ...
                        <div class="asset-slider-container">
                            ...
                            <div class="asset-preview-container">
                                <img id="arch-asset-preview" src="/Clara_Neulinger/05_PROJETS_3D/projets_portfolio/Arch/BASE COLOR/NewLevelSequence.0128.jpeg" alt="Asset Preview">
                            </div>
                        </div>
                    </div>
                    ` : ''}
                    ...
                    <div class="marmoset-extra-panel">
                        ...
                        <div class="asset-slider-container">
                            ...
                            <!-- Image d'aperçu -->
                            <div class="asset-preview-container">
                                <img id="gun-asset-preview" src="/Clara_Neulinger/05_PROJETS_3D/projets_portfolio/Gun/4.png" alt="Plasma Pistol Preview">
                            </div>
                        </div>
                    </div>
                    ` : ''}
                    ...
                    <div class="marmoset-extra-panel">
                        ...
                        <div class="asset-slider-container">
                            ...
                            <!-- Image d'aperçu -->
                            <div class="asset-preview-container">
                                <img id="telephone-asset-preview" src="/Clara_Neulinger/05_PROJETS_3D/projets_portfolio/Telephone/5.png" alt="Telephone Booth Preview">
                            </div>
                        </div>
                    </div>
                    ` : ''}
                    ...
                    <div class="marmoset-extra-panel">
                        ...
                        <div class="asset-slider-container">
                            ...
                            <!-- Image d'aperçu -->
                            <div class="asset-preview-container">
                                <img id="room-asset-preview" src="/Clara_Neulinger/05_PROJETS_3D/projets_portfolio/Room/fullQuality.png" alt="Room Preview">
                            </div>
                        </div>
                    </div>
    ...
    generateLogos(tags) {
        const logoMapping = {
            ...
            'Photoshop': { src: 'Designer.png', alt: 'Photoshop', title: 'Adobe Photoshop' },
            'Blender': { src: 'pngwing.com.png', alt: 'Blender', title: 'Blender' }
        };

        return tags.map(tag => {
            const logo = logoMapping[tag];
            if (logo) {
                return `<img src="/Clara_Neulinger/05_PROJETS_3D/Images_Portfolio/Logos/${logo.src}" alt="${logo.alt}" class="logo-item" title="${logo.title}">`;
            }
            return '';
        }).join('');
    }
    ...
    initArchAssetSlider() {
        ...
        const updateAssetImage = () => {
            ...
            const imagePath = `/Clara_Neulinger/05_PROJETS_3D/projets_portfolio/Arch/${currentAssetType}/NewLevelSequence.${frameNumber}.jpeg`;
    ...
    initGunImageNavigation() {
        ...
        const updateGunImage = (assetType) => {
            ...
            if (gunPreview && assetData) {
                gunPreview.src = `/Clara_Neulinger/05_PROJETS_3D/projets_portfolio/Gun/${assetData.file}`;
    ...
    initTelephoneImageNavigation() {
        ...
        const updateTelephoneImage = (assetType) => {
            ...
            if (telephonePreview && assetData) {
                telephonePreview.src = `/Clara_Neulinger/05_PROJETS_3D/projets_portfolio/Telephone/${assetData.file}`;
    ...
    loadProjectGallery(project) {
        ...
        const imageElements = images.map((imageName, index) => {
            const imagePath = `/Clara_Neulinger/05_PROJETS_3D/projets_portfolio/${project.folder}/${imageName}`;
            ...
            return `
                <div class="gallery-item" onclick="portfolioManager.openImageViewer('${imagePath}', ${index}, ${images.length}, '${project.title}')">
                    <img src="${imagePath}" 
                         ...
                         onload="this.style.opacity = 1; console.log('[OK] Image chargée: ${imageName}');"
    ...
    openImageViewer(imagePath, currentIndex, totalImages, projectTitle) {
        ...
        if (project) {
            ...
            this.currentGalleryImages = projectImages.map(img => `/Clara_Neulinger/05_PROJETS_3D/projets_portfolio/${project.folder}/${img}`);
        }
    ...
    loadMarmosetViewer(projectId, mviewFile) {
        ...
        // Utiliser le gestionnaire d'erreur Marmoset sécurisé
        if (window.createMarmosetViewer) {
            console.log('[OK] Gestionnaire Marmoset détecté, chargement sécurisé...');
            
            // Utiliser la fonction sécurisée
            window.createMarmosetViewer(marmosetContainer, mviewFile, projectId)
                .then((viewerElement) => {
                    console.log('[OK] Viewer Marmoset créé avec succès');
                    // Masquer le loading après succès
                    setTimeout(() => {
                        if (loadingOverlay) {
                ...
                .catch((error) => {
                    console.warn('[MARMOSET] Utilisation du fallback après erreur:', error);
                    // Le fallback est déjà affiché par createMarmosetViewer
                    if (loadingOverlay) {
                        loadingOverlay.style.display = 'none';
                    }
                });
        } else if (typeof marmoset !== 'undefined' && marmoset.embed) {
            console.log('[OK] Marmoset Viewer détecté (mode legacy)...');
            ...
            try {
                ...
                if (viewerElement) {
                    ...
                    console.log('[OK] Viewer Marmoset créé (mode legacy)');
                }
...
window.updateRoomSlider = function(imageType) {
    ...
    if (previewImg && imageMap[imageType]) {
        previewImg.src = `/Clara_Neulinger/05_PROJETS_3D/projets_portfolio/Room/${imageMap[imageType]}`;
...
window.updateRoomAssets = function(assetType) {
    ...
    if (previewImg && assetMap[assetType]) {
        previewImg.src = `/Clara_Neulinger/05_PROJETS_3D/projets_portfolio/Room/${assetMap[assetType]}`;
