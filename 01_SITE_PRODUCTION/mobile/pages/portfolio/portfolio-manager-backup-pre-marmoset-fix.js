class PortfolioManager {
    constructor() {
        ...
        this.projectFolders = [
            { 
                folder: 'Circus', 
                title: 'Projet : Circus',
                description: 'Ce projet personnel combine cr�ation d\'environnement et de personnage. Bas� sur un concept art de Yuri Gvozdenko, la sc�ne raconte une histoire � travers atmosph�re, �clairage et textures.',
                ...
                mainMedia: {
                    type: 'video',
                    src: '/Clara_Neulinger/05_PROJETS_3D/projets_portfolio/videos/Neulinger_Clara_3B3D_Circus_Render_Video.mp4'
                }
            },
            { 
                folder: 'Arch', 
                title: 'Projet : Archway',
                description: 'Un projet personnel d�di� � la cr�ation d\'une arche inspir�e du style celtique. Dans le cadre de ce projet, j\'ai d�cid� de r�interpr�ter une arche r�alis�e en 3D par Jonatan �sterberg, tout en d�veloppant un environnement complet autour de cette structure.',
                ...
                mainMedia: {
                    type: 'video',
                    src: '/Clara_Neulinger/05_PROJETS_3D/projets_portfolio/videos/Neulinger_Clara_3B3D_Archway_Render_Video.mp4'
                }
            },
            { 
                folder: 'Gun', 
                title: 'Projet : Plasma Pistol',
                description: 'Pistolet � plasma selon la r�f�rence conceptuelle de Robert Simons | Concept Art World.',
                ...
                mainMedia: {
                    type: 'image',
                    src: '/Clara_Neulinger/assets/images/Gun/NEULINGER_Clara_2B3DArt_Rendu_Texture.jpg'
                }
            },
            { 
                folder: 'Kitchen', 
                ...
                mainMedia: {
                    ...
                    src: window.isLowPerformanceDevice && window.isLowPerformanceDevice() ? 
                         '/Clara_Neulinger/assets/images/Kitchen/preview.jpg' : // Version l�g�re mobile
                         '/Clara_Neulinger/assets/images/Kitchen/NewLevelSequence1_0002_Ultra.png' // Image demand�e desktop
                }
            },
            { 
                folder: 'Room', 
                title: 'Projet : Room',
                description: 'Creation d\'un environment styl� en 3D d\'apr�s la r�f�rence de Thanh DO etc... (WIP - Work In Progress)',
                tags: ['Marvelous Designer', 'Maya', 'Marmoset', 'Substance Painter'],
                category: '3D',
                viewerFiles: {
                    environment: '/Clara_Neulinger/assets/images/Room/Room_Viewer_Test.html'
                },
                mainMedia: {
                    type: 'image',
                    src: '/Clara_Neulinger/assets/images/Room/Untitled_Camera 1_FullQuality.jpg'
                }
            },
            { 
                folder: 'Telephone', 
                title: 'Projet : Telephone Booth',
                description: 'R�alisation de la texture � partir d\'un mod�le 3D de cabine t�l�phonique cr�� avec Maya.',
                tags: ['Maya', 'Substance Painter'],
                category: '3D',
                viewerFiles: {
                ...
                mainMedia: {
                    type: 'image',
                    src: '/Clara_Neulinger/assets/images/Telephone/NEULINGER_CLARA_2B3DART_TELEPHONE_5.jpg'
                }
            }
        ];
        ...
        for (let i = 0; i < this.projectFolders.length; i++) {
            ...
            const project = {
                ...
                mainMedia: folderConfig.mainMedia || {
                    type: 'image',
                    src: `/Clara_Neulinger/assets/images/${folderConfig.folder}/preview.jpg`
                }
            };

            this.projects.push(project);
            console.log(`[OK] Projet ${project.title} configur� avec template Marmoset`);
        }
    }
    ...
    previousProject() {
        ...
        this.updatePageCounter(); // Ajout de la mise � jour du compteur
        console.log(`[PROJECT] Projet pr�c�dent: ${this.projects[this.currentProject].title}`);
    }
    ...
    // Nouvelle m�thode pour mettre � jour le compteur de pages
    updatePageCounter() {
    ...
    updateProjectDisplay() {
        ...
        if (projectShowcase) {
            // G�n�rer le m�dia principal selon le type configur�
                ...
                <div class="project-container">
                    <div class="project-media-wrapper" 
                        ...
                        <div class="project-overlay">
                            <div class="project-overlay-text">
                                <span class="desktop-instruction">Double-cliquez pour explorer</span>
                                <span class="mobile-instruction">Touchez pour explorer</span>
                            </div>
                        </div>
                    </div>
                    <div class="project-info-side">
                        ...
                        <div class="project-hint">
                            <small><span class="white-bulb">[INFO]</span> Double-cliquez sur ${project.mainMedia.type === 'video' ? 'la vid�o' : 'l\'image'} pour acc�der au viewer 3D interactif</small>
                        </div>
                    </div>
                </div>
            </div>
            ...
            // Repositionner le bouton apr�s mise � jour du contenu
            setTimeout(() => {
    ...
    // G�n�rer l'�l�ment m�dia principal selon la configuration
    ...
    handleMobileClick(event, projectId) {
        // D�tection si c'est un appareil mobile/tablette
    ...
    openProjectDetails(projectId) {
        ...
        // Utiliser le template Marmoset avec protection d'erreur
        this.showMarmosetViewerTemplate(project);
    }

    // Template Marmoset g�n�rique pour tous les projets
    showMarmosetViewerTemplate(project) {
        console.log(`[MARMOSET] Affichage du template pour: ${project.title}`);
        
        // Cr�er une modal avec galerie, viewer et infos
            ...
            <div class="marmoset-modal-content">
                ...
                <div class="marmoset-main-container">
                    <div class="marmoset-gallery-panel">
                        <h3>Galerie</h3>
                        <p class="gallery-instructions">Cliquez sur une image pour l'agrandir � Utilisez les fl�ches pour naviguer</p>
                        <div class="gallery-scroll-container" id="${project.folder.toLowerCase()}-gallery">
                            <zone-labels!-- Images seront ajout�es ici -->
                        </div>
                    </div>
                        ...
                        <div class="viewer-wrapper">
                            ${project.folder === 'Arch' ? 
                                `<video controls autoplay muted loop style="width: 100%; height: 100%; border-radius: 8px;">
                                    <source src="/Clara_Neulinger/05_PROJETS_3D/projets_portfolio/videos/Neulinger_Clara_3B3D_Archway_Render_Video.mp4" type="video/mp4">
                                    Votre navigateur ne supporte pas la lecture de vid�os.
                                </video>` :
                                `<iframe id="marmoset-viewer-inline" 
                                        src="/Clara_Neulinger/assets/images/${project.folder}/${project.viewerFiles?.environment || 'placeholder.html'}" 
                                        width="100%" 
                                        height="100%" 
                                        frameborder="0"
                                        allowfullscreen>
                    ...
                    ${project.folder === 'Arch' ? `
                    <!-- TEMPLATE R�UTILISABLE : Visualisateur de mat�riaux avec slider interactif -->
                    <!-- Peut �tre �tendu � d'autres projets (Room, Kitchen, Gun, etc.) -->
                    <div class="marmoset-extra-panel">
                        <h3>Visualiseur - Archway</h3>
                        <div class="asset-slider-container">
                            <!-- S�lecteur de type d'asset -->
                            ...
                            <div class="asset-preview-container">
                                <img id="arch-asset-preview" src="/Clara_Neulinger/assets/images/Arch/BASE COLOR/NewLevelSequence.0128.jpeg" alt="Asset Preview">
                            </div>
                        </div>
                    </div>
                    ` : ''}
                    ...
                    ${project.folder === 'Gun' ? `
                    <!-- TEMPLATE R�UTILISABLE : Visualisateur de mat�riaux avec slider interactif pour Plasma Pistol -->
                    <div class="marmoset-extra-panel">
                        ...
                        <div class="asset-slider-container">
                            ...
                            <!-- Image d'aper�u -->
                            <div class="asset-preview-container">
                                <img id="gun-asset-preview" src="/Clara_Neulinger/assets/images/Gun/4.png" alt="Plasma Pistol Preview">
                            </div>
                        </div>
                    </div>
                    ` : ''}
                    ...
                    <!-- TEMPLATE R�UTILISABLE : Visualisateur de mat�riaux avec slider interactif pour Telephone Booth -->
                    <div class="marmoset-extra-panel">
                        ...
                        <div class="asset-slider-container">
                            ...
                            <!-- Image d'aper�u -->
                            <div class="asset-preview-container">
                                <img id="telephone-asset-preview" src="/Clara_Neulinger/assets/images/Telephone/5.png" alt="Telephone Booth Preview">
                            </div>
                        </div>
                    </div>
                    ` : ''}
                    ...
                    ${project.folder === 'Room' ? `
                    <!-- TEMPLATE R�UTILISABLE : Visualisateur de mat�riaux avec slider interactif pour Room -->
                    <div class="marmoset-extra-panel">
                        ...
                        <div class="asset-slider-container">
                            ...
                            <!-- Image d'aper�u -->
                            <div class="asset-preview-container">
                                <img id="room-asset-preview" src="/Clara_Neulinger/assets/images/Room/fullQuality.png" alt="Room Preview">
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Panel Histoire sp�cifique pour Kitchen/The Last Meal -->
                    <div class="marmoset-story-panel">
                        <div class="story-content">
                            <h3>L'Histoire du Projet</h3>
                            <div class="story-text">
                                <p>Au fin fond d'une ruelle sombre se trouve cach�e entre des murs de b�ton une petite cuisine clandestine, lugubre et remplie de salet�s ne donnant aucune envie d'y passer la porte.</p>
                                
                                <p>Mais une fois la porte ouverte, une triste r�alit� s'offre � nos yeux. Dans cette pi�ce, un mur fait de carrelage probablement devenu jaun�tre par le manque de propret� est accompagn� de taches d'un rouge sombre d�cim�e un peu par tout sur ce mur froid s'y trouve. Le plan de travail n'est pas en meilleur �tat, c'est un bois brute qui nous accueille o� r�side des taches orange annon�ant l'horreur de cette cuisine.</p>
                                
                                <p>Quand nos yeux se plissent d'avantage, les objets dispos�s deviennent nets. Couteaux, haches et casseroles trouvent leur place sur ce plan de travail. Cette vue qui se peint devant nos yeux � travers cette porte entre ouverte annonce quelque chose de mauvais, mais ce n'est qu'une fois que notre pied, doucement et faiblement franchit la porte afin de se retrouver � l'int�rieur que la v�rit� �clate au grand jour.</p>
                                
                                <p>Une fois rentr� pleinement dans la pi�ce, face � nos yeux l'enfer se trouve. Cette cuisine n'est pas que sombre et lugubre c'est aussi le rep�re des cuisiniers d�nu�s de conscience, abattant des carottes sans peine et remord.</p>
                                
                                <p>Une boucherie s'affiche face � nous, o� les ustensiles de cuisine se transforment en objet de torture. Les couteaux et les haches sont plant�s � la verticale sur le bois brut pouvant c�der � tout moment. La casserole rouill�e et r�cemment utilis�e sont l'�uvre de ce r�cent massacre.</p>
                                
                                <p>Partout o� nos yeux se posent, nous pouvons voir des carottes d�nu�es de vie, baignant dans leur propre sang dans des casseroles. Des bouts de carottes d�coup�es de parts et d'autres du plan de travail, des carottes bless�es essayant de lutter contre leur sort et de s'�chapper comme elles le peuvent malgr� le pauvre destin qui leur est r�serv�.</p>
                                
                                <p>Mais parmi elle, seuls deux rescap�s de cette tuerie tente de s'�chapper en vint. Rampant et sautant aussi vite que leur blessures peuvent le permettre. Alors, elles rampent, sautent, tr�buchent, tombent, se rel�ves afin d'atteindre la porte de sortie. Cette porte de sortie qui leur permettra vie sauve et extraction loin de ce massacre auxquels elles ont d� assister sans pouvoir dire un mot.</p>
                                
                                <p>Cette sc�ne se d�roulant sous nos propres yeux, nous savons d'avance qu'elles n'�chapperont pas � la sinistre cuisson qui les attend, car toutes les riches personnes de cette ville ont pay�es ces cuisiners afin qui leur pr�pare des plats go�tus, gastronomique, remplis de saveur � base de carotte.</p>
                                
                                <p>Cette somme d'argent assez �lev�e fait disparaitre toute once d'humanit� chez les cuisiniers. D'ailleurs en parlant d'eux, je crois entendre le minuteur sonner.</p>
                                
                                <p><strong>La cuisson est alors pr�te.</strong></p>
                            </div>
                        </div>
                    </div>
                    ` : ''}
                    ...
                    <!-- Deuxi�me viewer 3D pour le personnage (si existe) -->
                    <div class="marmoset-chara-viewer-container">
                        ...
                        <div class="viewer-wrapper">
                            <iframe id="marmoset-chara-viewer-inline" 
                                    src="/Clara_Neulinger/assets/images/${project.folder}/${project.viewerFiles.character}" 
                                    width="100%" 
                                    height="100%" 
                                    frameborder="0"
                                    allowfullscreen>
        ...
        // R�initialiser l'effet parallaxe pour le nouveau bouton
        ...
        console.log(`[MARMOSET] Template charg� pour ${project.title}`);
    }

    // G�n�rer les logos en fonction des tags du projet
    generateLogos(tags) {
        const logoMapping = {
        ...
        return tags.map(tag => {
            ...
            if (logo) {
                return `<img src="/Clara_Neulinger/assets/images/Logos/${logo.src}" alt="${logo.alt}" class="logo-item" title="${logo.title}">`;
            }
            return '';
        }).join('');
    }
    ...
    initArchAssetSlider() {
        ...
        // Fonction pour d�terminer le type d'asset selon la position du slider
        const getAssetTypeFromSlider = (sliderValue) => {
            // Ordre modifi� : Base Color, AO, Metallic, Roughness
            // R�partir les 22 frames (128-149) sur 4 types d'assets
        ...
        // Fonction pour mettre � jour l'image et l'interface
        const updateAssetImage = () => {
            ...
            const imagePath = `/Clara_Neulinger/assets/images/Arch/${currentAssetType}/NewLevelSequence.${frameNumber}.jpeg`;
        ...
        // Gestion des boutons de type d'asset - sauter � la section correspondante
        assetTypeBtns.forEach(btn => {
            btn.addEventListener('click', () => {
                const assetType = btn.dataset.type;
                // D�finir la frame de d�part pour chaque type (nouvel ordre)
                switch(assetType) {
                ...
                assetSlider.value = currentSliderValue; // Mettre � jour le slider
                updateAssetImage();
            });
        });
        ...
        console.log('[ARCH SLIDER] Slider d\'assets auto-switch initialis�');
    }
    ...
    initGunImageNavigation() {
        ...
        const updateGunImage = (assetType) => {
            ...
            if (gunPreview && assetData) {
                gunPreview.src = `/Clara_Neulinger/assets/images/Gun/${assetData.file}`;
                ...
                console.log(`[GUN VIEWER] Image chang�e vers: ${assetData.file} (${assetType})`);
            }
        };
        ...
        // Initialiser avec Rendu Final (premi�re image dans l'ordre)
        updateGunImage('FINAL');
        
        console.log('[GUN NAVIGATION] Navigation des images Plasma Pistol avec slider initialis�e');
    }
    ...
    initRoomNavigation() {
        ...
        if (!roomSlider) {
            console.warn('[ROOM NAVIGATION] Slider Room non trouv�');
            return;
        }
        ...
        // Fonction de mise � jour de l'image Room
        const updateRoomImage = (assetType) => {
            if (typeof window.updateRoomAssets === 'function') {
                ...
                console.log(`[ROOM VIEWER] Image chang�e vers: ${assetType}`);
            }
        };
        ...
        // Initialiser avec Full Quality (premi�re image)
        updateRoomImage('FULL_QUALITY');
        
        console.log('[ROOM NAVIGATION] Navigation des images Room avec slider initialis�e');
    }
    ...
    initTelephoneImageNavigation() {
        ...
        const updateTelephoneImage = (assetType) => {
            ...
            if (telephonePreview && assetData) {
                telephonePreview.src = `/Clara_Neulinger/assets/images/Telephone/${assetData.file}`;
                ...
                console.log(`[TELEPHONE VIEWER] Image chang�e vers: ${assetData.file} (${assetType})`);
            }
        };
        ...
        console.log('[TELEPHONE NAVIGATION] Navigation des images Telephone Booth avec slider initialis�e');
    }

    // M�thode pour charger les images de galerie d'un projet
    loadProjectGallery(project) {
        ...
        // Images r�elles pour chaque projet
        const projectImages = {
            'circus': [
        ...
        console.log(`[GALLERY DEBUG] Projet: ${project.folder.toLowerCase()}, Images trouv�es:`, images);
        
        if (images.length === 0) {
            console.log(`[GALLERY DEBUG] Aucune image trouv�e pour ${project.folder.toLowerCase()}`);
            galleryContainer.innerHTML = '<p class="no-images">Images en cours de pr�paration...</p>';
            return;
        }

        // Cr�er les �l�ments d'image avec chargement intelligent
        const imageElements = images.map((imageName, index) => {
            const imagePath = `/Clara_Neulinger/assets/images/${project.folder}/${imageName}`;
            ...
            return `
                <div class="gallery-item" onclick="portfolioManager.openImageViewer('${imagePath}', ${index}, ${images.length}, '${project.title}')">
                    <img src="${imagePath}" 
                         ...
                         onload="this.style.opacity = 1; console.log('[OK] Image charg�e: ${imageName}');"
        ...
        console.log(`[GALLERY] ${images.length} images ajout�es pour ${project.title}`);
    }

    // Lazy loading supprim� - chargement imm�diat pour des performances optimales

    // M�thode helper pour r�cup�rer les images d'un projet
    ...
    // Viewer d'images avec navigation par fl�ches
    openImageViewer(imagePath, currentIndex, totalImages, projectTitle) {
        ...
        // R�cup�rer toutes les images du projet actuel
        ...
        if (project) {
            ...
            this.currentGalleryImages = projectImages.map(img => `/Clara_Neulinger/assets/images/${project.folder}/${img}`);
        }

        // Template uniforme pour tous les projets - structure bas�e sur Circus qui fonctionne bien
        const modal = document.createElement('div');
        ...
        this.keyboardHandler = (e) => {
            if (e.key === 'ArrowLeft' && !keyboardThrottle) {
                ...
                setTimeout(() => { keyboardThrottle = false; }, 100); // Navigation tr�s fluide
        ...
        // Observer pour nettoyer quand la modal est supprim�e du DOM
    ...
    loadMarmosetViewer(projectId, mviewFile) {
        ...
        // Utiliser le gestionnaire d'erreur Marmoset s�curis�
        if (window.createMarmosetViewer) {
            console.log('[OK] Gestionnaire Marmoset d�tect�, chargement s�curis�...');
            
            // Utiliser la fonction s�curis�e
            window.createMarmosetViewer(marmosetContainer, mviewFile, projectId)
                .then((viewerElement) => {
                    console.log('[OK] Viewer Marmoset cr�� avec succ�s');
                    // Masquer le loading apr�s succ�s
                    setTimeout(() => {
                        if (loadingOverlay) {
                ...
                .catch((error) => {
                    console.warn('[MARMOSET] Utilisation du fallback apr�s erreur:', error);
                    // Le fallback est d�j� affich� par createMarmosetViewer
                    if (loadingOverlay) {
                        loadingOverlay.style.display = 'none';
                    }
                });
        } else if (typeof marmoset !== 'undefined' && marmoset.embed) {
            console.log('[OK] Marmoset Viewer d�tect� (mode legacy)...');
            
            try {
                // Mode legacy avec protection basique
                ...
                if (viewerElement) {
                    ...
                    console.log('[OK] Viewer Marmoset cr�� (mode legacy)');
                }
                ...
                setTimeout(() => {
                    ...
                    console.log('[OK] Loading overlay masqu�');
                }, 2000);
                
            } catch (legacyError) {
                console.error('[MARMOSET] Erreur mode legacy:', legacyError);
                marmosetContainer.innerHTML = `
                    <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; height: 100%; background: #1a1a1a; color: white; text-align: center; padding: 20px;">
                        <h3>Viewer 3D temporairement indisponible</h3>
            ...
            console.log('[WARNING] Marmoset Viewer non disponible, v�rification dans 2 secondes...');
            
            // R�essayer apr�s un d�lai pour laisser le temps au script de se charger
            setTimeout(() => {
    ...
    // Ancienne fonction sp�cifique supprim�e - utilise maintenant le template g�n�rique

    // Anciennes fonctions sp�cifiques supprim�es - remplac�es par le syst�me g�n�rique
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (!window.portfolioManager) {
        ...
        window.portfolioManager.initProjectsFromFolders().then(() => {
            ...
            console.log('[PORTFOLIO] Initialisation compl�te');
        });
    }
});
...
PortfolioManager.prototype.showPortfolioCollectibles = function() {
    ...
    // R�initialiser l'effet parallaxe pour tous les boutons de la page collectibles
    if (window.buttonParallaxManager) {
        setTimeout(() => {
            window.buttonParallaxManager.setup();
            console.log('[PORTFOLIO] Parallaxe r�initialis� pour les collectibles');
        }, 100);
    }
};

// Fonction simplifi�e - pas de repositionnement JS, seulement CSS
PortfolioManager.prototype.repositionReturnButton = function() {
    console.log('[PORTFOLIO] Repositionnement g�r� uniquement par CSS');
    
    // R�initialiser le parallax sur le bouton
    if (window.buttonParallaxManager) {
        setTimeout(() => {
            window.buttonParallaxManager.setup();
        }, 100);
...
PortfolioManager.prototype.showPortfolioCollectibles = function() {
    ...
    // Repositionner le bouton IMM�DIATEMENT puis apr�s d�lai
    this.repositionReturnButton();
...
window.updateRoomSlider = function(imageType) {
    ...
    // Optionnel: mettre � jour une image d'aper�u si n�cessaire
    const previewImg = document.querySelector('#room-asset-preview');
    if (previewImg && imageMap[imageType]) {
        previewImg.src = `/Clara_Neulinger/assets/images/Room/${imageMap[imageType]}`;
        previewImg.alt = imageType;
    }
    
    console.log('[ROOM SLIDER] Image chang�e vers:', imageMap[imageType]);
};

// Fonction globale pour g�rer les assets Room
window.updateRoomAssets = function(assetType) {
    console.log('[ROOM ASSETS] Changement vers:', assetType);
    
    // D�finir les mappages d'images pour les assets
    const assetMap = {
    ...
    // Mettre � jour l'image d'aper�u
    const previewImg = document.querySelector('#room-asset-preview');
    if (previewImg && assetMap[assetType]) {
        previewImg.src = `/Clara_Neulinger/assets/images/Room/${assetMap[assetType]}`;
        previewImg.alt = `Room ${assetType}`;
    }
    
    // Mettre � jour le slider correspondant
    const sliderMap = {
        'FULL_QUALITY': 1,
        'CAMERA_2': 2,
        'ALBEDO': 3,
    ...
    console.log('[ROOM ASSETS] Asset chang� vers:', assetMap[assetType]);
};

// Fonctions globales pour les contr�les de slider Room
...
// �v�nements pour les boutons d'assets Room
